...
def test_step_display_class():
    ...
    with StepDisplay("test_step", "Test step:", timings, AutoProgressBar(True), True) as disp:
        assert disp is not None
        # Test update method
        disp.update(1, 5, "test item")
    
    # Test with progress and timing disabled
    with StepDisplay("test_step", "Test step:", timings, AutoProgressBar(False), False) as disp:
        assert disp is not None
        # Test update method
        disp.update(1, 5, "test item")
